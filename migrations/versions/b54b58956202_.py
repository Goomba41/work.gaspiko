...
Revision ID: b54b58956202
Revises: d766b715ca55
Create Date: 2017-06-09 10:41:04.614146
...
revision = 'b54b58956202'
down_revision = 'd766b715ca55'
branch_labels = None
depends_on = None
...
def downgrade_():
    ...
    op.create_foreign_key(u'user_ibfk_1', 'user', 'role', ['role_id'], ['id'])
    op.create_foreign_key(u'user_ibfk_2', 'user', 'post', ['post_id'], ['id'])
    ...
    op.drop_constraint(None, 'permission', schema='arhiv', type_='foreignkey')
    op.drop_constraint(None, 'permission', schema='arhiv', type_='foreignkey')
    op.create_foreign_key(u'permission_ibfk_2', 'permission', 'table', ['table_id'], ['id'])
    op.create_foreign_key(u'permission_ibfk_3', 'permission', 'user', ['user_id'], ['id'])
    op.create_foreign_key(u'permission_ibfk_4', 'permission', 'role', ['role_id'], ['id'])
...
def upgrade_kartoteka():
    ...
    op.add_column(u'request', sa.Column('kind_id', sa.Integer(), nullable=True))
...
def downgrade_kartoteka():
    ...
    op.drop_column(u'request', 'kind_id')
    ...
    op.drop_table('kind', schema='kartoteka')
    # ### end Alembic commands ###
