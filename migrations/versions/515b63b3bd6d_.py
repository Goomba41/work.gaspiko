...
Revision ID: 515b63b3bd6d
Revises: b54b58956202
Create Date: 2017-06-09 10:56:50.669615
...
revision = '515b63b3bd6d'
down_revision = 'b54b58956202'
branch_labels = None
depends_on = None
...
def upgrade_kartoteka():
    ...
    op.add_column(u'request', sa.Column('character_id', sa.Integer(), nullable=True))
...
def downgrade_kartoteka():
    ...
    op.drop_constraint(None, 'request', type_='foreignkey')
    op.create_foreign_key(u'request_ibfk_1', 'request', 'kind', ['kind_id'], ['id'])
    op.drop_column(u'request', 'character_id')
    ...
    op.drop_table('character', schema='kartoteka')
    # ### end Alembic commands ###
