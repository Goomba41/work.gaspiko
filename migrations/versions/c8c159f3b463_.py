...
Revision ID: c8c159f3b463
Revises: 5ff11296ce2a
Create Date: 2017-06-09 11:15:15.721260
...
revision = 'c8c159f3b463'
down_revision = '5ff11296ce2a'
branch_labels = None
depends_on = None
...
def upgrade_kartoteka():
    ...
    op.add_column(u'request', sa.Column('answer_id', sa.Integer(), nullable=True))
    op.add_column(u'request', sa.Column('send_id', sa.Integer(), nullable=True))
...
def downgrade_kartoteka():
    ...
    op.drop_constraint(None, 'request', type_='foreignkey')
    op.drop_constraint(None, 'request', type_='foreignkey')
    op.create_foreign_key(u'request_ibfk_2', 'request', 'executor', ['executor_id'], ['id'])
    op.create_foreign_key(u'request_ibfk_1', 'request', 'character', ['character_id'], ['id'])
    op.create_foreign_key(u'request_ibfk_3', 'request', 'kind', ['kind_id'], ['id'])
    op.drop_column(u'request', 'send_id')
    op.drop_column(u'request', 'answer_id')
    op.add_column(u'executor', sa.Column('user_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=False))
    ...
    op.drop_table('send', schema='kartoteka')
    op.drop_table('answer', schema='kartoteka')
    # ### end Alembic commands ###
